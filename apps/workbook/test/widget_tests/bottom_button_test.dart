...
import 'package:workbook/core/ui/widgets/buttons/bottom_button_cmp.dart';
...
BottomButtonCmp getWidget(GestureTapCallback? onTap) => BottomButtonCmp(
    title: 'test btn',
    onPressed: onTap,
  );
